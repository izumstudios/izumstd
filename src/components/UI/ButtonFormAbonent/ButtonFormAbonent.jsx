...
import styles from './ButtonFormAbonent.module.scss'
...
const ButtonFormAbonent = ({ title, link }) => {
	...
	return (
		<div className={styles.btn}>
			<button onClick={handleOneOpen} className={styles.secondary}>
				{title}
			</button>
			<Modal
...
export default ButtonFormAbonent
